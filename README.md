...
## Goal - Front End
In this [separate workshop](https://github.com/yannklein/react-workshop-ref-feb2024/), we'll build a [React application](https://yannklein.github.io/react-workshop-ref) to consume this API.
<p>
